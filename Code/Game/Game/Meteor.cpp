...
namespace Game
{
	...
	void Meteor::OnRender()
	{
		Saz::Renderer2D::DrawRotatedQuad({ m_Position.x, m_Position.y, -0.5f }, m_Size, glm::radians(m_Rotation), { 0.35f, 0.3f, 0.2f, 1.0f });
	}
	...
	void Meteor::Reset()
	{
		m_Position = { Random::Range(10.0f, 20.0f), Random::Range(-10.0f, 10.0f) };
