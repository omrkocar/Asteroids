...
namespace
{
	...
	static void PrintAssemblyTypes(MonoAssembly* assembly)
	{
		...
		for (int32_t i = 0; i < numTypes; i++)
		{
			...
			SAZ_CORE_TRACE("{0}.{1}", nameSpace, name);
		}
	}
}
...
namespace Saz
{
	...
	void ScriptEngine::InitMono()
	{
		...
		s_Data->CoreAssembly = LoadMonoAssembly("../../Code/Editor/Resources/Scripts/ScriptCore.dll");
		...
		MonoClass* monoClass = mono_class_from_name(assemblyImage, "Saz", "Main");
