...
namespace fw
{
	...
	Window* Window::Create(const fw::WindowProps& props)
	{
		return new WindowsWindow(props);
	}

	WindowsWindow::WindowsWindow(const fw::WindowProps& props)
	{
		Init(props);
	}
	...
	void WindowsWindow::Init(const fw::WindowProps& props)
	{
		...
		if (!s_GLFWInitialized)
		{
			...
			T_ASSERT(success, "Could not initialize GLFW!");
