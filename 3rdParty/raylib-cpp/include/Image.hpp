...
class Image : public ::Image {
 public:
    ...
    void Load(const std::string& fileName) {
        set(::RayLoadImage(fileName.c_str()));
    }
     ...
     */
    inline ::Image FromImage(::RayRectangle rec) const {
     ...
     */
    inline Image& Crop(::RayRectangle crop) {
        ::ImageCrop(this, crop);
        return *this;
    }
     ...
     */
    inline RayRectangle GetAlphaBorder(float threshold) const {
    ...
    inline Image& DrawRectangle(::RayRectangle rec, ::Color color = {255, 255, 255, 255}) {
        ::ImageDrawRectangleRec(this, rec, color);
        return *this;
    }

    inline Image& DrawRectangleLines(::RayRectangle rec, int thick = 1,
            ::Color color = {255, 255, 255, 255}) {
        ::ImageDrawRectangleLines(this, rec, thick, color);
        return *this;
    }

    inline Image& Draw(const ::Image& src, ::RayRectangle srcRec, ::RayRectangle dstRec,
            ::Color tint = {255, 255, 255, 255}) {
