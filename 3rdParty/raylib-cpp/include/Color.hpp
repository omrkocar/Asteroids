...
class Color : public ::Color {
 public:
    ...
    inline Color& DrawText(const ::Font& font, const std::string& text, ::Vector2 position,
        ...
        ::RayDrawTextEx(font, text.c_str(), position, fontSize, spacing, *this);
        return *this;
    }
    ...
    inline Color& DrawRectangle(::RayRectangle rec) {
        ::DrawRectangleRec(rec, *this);
        return *this;
    }

    inline Color& DrawRectangle(::RayRectangle rec, ::Vector2 origin, float rotation) {
    ...
    inline Color& DrawRectangleLines(::RayRectangle rec, float lineThick) {
