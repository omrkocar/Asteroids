...
class Texture : public ::Texture {
 public:
     ...
     */
    inline Texture& UpdateRec(RayRectangle rec, const void *pixels) {
    ...
    inline Texture& Draw(RayRectangle sourceRec, ::Vector2 position = {0, 0},
            ::Color tint = {255, 255, 255, 255}) {
        ::DrawTextureRec(*this, sourceRec, position, tint);
        return *this;
    }

    inline Texture& Draw(::Vector2 tiling, ::Vector2 offset, RayRectangle quad,
            ::Color tint = {255, 255, 255, 255}) {
        ::DrawTextureQuad(*this, tiling, offset, quad, tint);
        return *this;
    }

    inline Texture& Draw(RayRectangle sourceRec, RayRectangle destRec, ::Vector2 origin = {0, 0},
            float rotation = 0, ::Color tint = {255, 255, 255, 255}) {
        ::DrawTexturePro(*this, sourceRec, destRec, origin, rotation, tint);
        return *this;
    }

    inline Texture& Draw(::NPatchInfo nPatchInfo, RayRectangle destRec, ::Vector2 origin = {0, 0},
            float rotation = 0, ::Color tint = {255, 255, 255, 255}) {
    ...
    inline Texture& DrawTiled(RayRectangle sourceRec, RayRectangle destRec, ::Vector2 origin = {0, 0},
     ...
     */
    inline Texture& SetShapes(const RayRectangle& source) {
