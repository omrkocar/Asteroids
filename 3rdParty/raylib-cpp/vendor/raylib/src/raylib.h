...
// RayRectangle, 4 components
typedef struct RayRectangle {
    float x;                // RayRectangle top-left corner position x
    float y;                // RayRectangle top-left corner position y
    float width;            // RayRectangle width
    float height;           // RayRectangle height
} RayRectangle;
...
typedef struct NPatchInfo {
    RayRectangle source;       // Texture source rectangle
...
RLAPI void DrawRectangleRounded(RayRectangle rec, float roundness, int segments, Color color);              // Draw RayRectangle with rounded edges
RLAPI void DrawRectangleRoundedLines(RayRectangle rec, float roundness, int segments, float lineThick, Color color); // Draw rectangle with rounded edges outline
...
RLAPI void DrawTexturePro(Texture2D texture, RayRectangle source, RayRectangle dest, Vector2 origin, float rotation, Color tint);           // Draw a part of a texture defined by a rectangle with 'pro' parameters
...
RLAPI void DrawCubeTextureRec(Texture2D texture, RayRectangle source, Vector3 position, float width, float height, float length, Color color); // Draw cube with a region of a texture
